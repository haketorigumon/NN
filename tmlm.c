...
#define CLAUSES_OF_INPUT_LAYER 256
#define FEATURES_PER_CLAUSE_OF_INPUT_LAYER VOCAB_SIZE
#define BLOCKS_OF_META_LAYER CLAUSES_OF_INPUT_LAYER
#define CLAUSES_PER_BLOCK_OF_META_LAYER FEATURES_PER_CLAUSE_OF_INPUT_LAYER
#define MEM FEATURES_PER_CLAUSE_OF_BLOCK
#define FEATURES_PER_CLAUSE_OF_BLOCK CLAUSES_OF_INPUT_LAYER
#define CLAUSES_PER_CLASS 256
#define FEATURES_PER_CLAUSE_OF_CLASS CLAUSES_OF_INPUT_LAYER
